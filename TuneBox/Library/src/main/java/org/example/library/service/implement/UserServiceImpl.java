    ...
    public class UserServiceImpl implements UserService {
        ...
        public UserDto Register(RequestSignUpModel requestSignUpModel) {
            ...
            Optional<Role> roleOptional = roleRepo.findByName("CUSTOMER");
            if (roleOptional.isPresent()) {
                // Chuyển Optional<Role> thành List<Role> và gán cho user
                savedUser.setRole(Collections.singletonList(roleOptional.get()));
            } else {
